    ...
    public class ConverterService
    {
        ...
        public MemoryStream SetExcelInshurance(Dictionary<string, ExcelRows> excelKeyValuePairs, Dictionary<string, PdfTables> pdfKeyValuePairs)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[1, 4].Value = "Сумма в Пдф";
                worksheet.Cells[1, 5].Value = "Сумма в Эксел";
                ...
                using (var headerRange = worksheet.Cells[1, 1, 1, 7])
                {
                    ...
                    headerRange.Style.Font.Size = 14; // Увеличенный размер шрифта
                ...
                foreach (var val in excelKeyValuePairs)
                {
                    ...
                    {
                        worksheet.Cells[row, 7].Value = "Не найден клиент из Выписка, по проведенным платежам";
                        color = "red";
                ...
                foreach (var val in pdfKeyValuePairs)
                {
                    ...
                    worksheet.Cells[row, 7].Value = "Не найден клиент из Расчетная ведомоста";
